    ...
    <div className="p-5 h-full w-full overflow-y-auto no-scrollbar flex flex-col gap-5">
          ...
          <div className="h-[100px] bg-white w-full rounded-sm border flex items-center  p-5 justify-between">
            <div className="">
              ...
              <h3 className="lg:text-[24px] font-Regular p-0 text-[16px]">
                Welcome to {currentUser?.name ? currentUser?.name : "Edmas"},
              </h3>
      ...
      <div className="h-full w-full lg:flex-row flex flex-col gap-5">
        <div className="h-full w-full flex flex-col gap-5">
          <div className={`p-3 border-b h-full bg-white rounded-sm border ${contextValue?.noticeboardBySchoolId?.length>0 ?'flex flex-col':'flex flex-col items-center justify-center'}`}>
